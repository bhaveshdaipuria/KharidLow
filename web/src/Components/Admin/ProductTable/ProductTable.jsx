...
const ProductTable = () => {
	...
	return (
		<>
									...
									<table className="product-table-table">
										<thead>
											<tr>
												...
												<th>
													<div className="text-center">Price Slabs</div>
												</th>
												<th>
			...
			></ProductImagesModal>
			<PriceSlabModal
				isOpen={isPriceSlabModalOpen}
				setIsOpen={setIsPriceSlabModalOpen}
			></PriceSlabModal>
			<ProductPreviewModal
			...
			<ConfirmationModal
				...
				confirmationPass={"Confirm"}
				action={"Do you really want to delete this item?"}
				onConfirmation={() => {
					delProduct(selectedProduct._id);
				}}
			></ConfirmationModal>
