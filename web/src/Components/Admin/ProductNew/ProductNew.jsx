...
function ProductNew() {
	...
	return (
		<>
			<form
				className="container mx-auto px-4 product-new-outer py-5"
			...
			>
				<h2 className="add-product-main-heading">Add Product</h2>
				...
				<div className="product-category-sec">
					...
					<div className="grid grid-cols-1 md:grid-cols-4 gap-5">
						<FormControl
							isRequired
							isInvalid={submitted && !productNewForm.category}
						>
						...
						<FormControl
							isRequired
							isInvalid={submitted && !productNewForm.subCategory}
						>
						...
						<FormControl
							isRequired
							isInvalid={submitted && !productNewForm.item}
						>
				...
				<div className="product-category-sec">
					...
					<div className="grid grid-cols-1 md:grid-cols-4 gap-5">
						<FormControl
							isRequired
							isInvalid={submitted && !productNewForm.productName}
						>
							...
							<Input
								...
								name="productName"
								size="sm"
								value={productNewForm.productName}
								onChange={(e) => {
						...
						<FormControl
							isRequired
							isInvalid={submitted && !productNewForm.subHead}
						>
						...
						<FormControl
							isRequired
							isInvalid={submitted && !productNewForm.sku}
						>
						...
						<FormControl
							...
							isInvalid={submitted && !productNewForm.summary}
						>
							<FormLabel className="form-label-sm">Product summary</FormLabel>
							<Textarea
								placeholder="Product Summary"
								name="summary"
								value={productNewForm.summary}
								onChange={(e) => {
									handleInputChange(e, setProductNewForm);
								}}
								rows={8}
				...
				<div className="product-category-sec">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-5">
							...
							return (
								...
								>
									<FormControl
										isRequired
										isInvalid={
											submitted && !productNewForm.keyHighlights[index].key
										}
									>
										...
										<Input
											placeholder="Name"
											size="sm"
											value={productNewForm.keyHighlights[index].key}
											name="key"
											onChange={(e) => {
												handleKeyHighlightsChange(e, index, setProductNewForm);
											}}
										/>
									...
									<FormControl
										isRequired
										isInvalid={
											submitted && !productNewForm.keyHighlights[index].value
										}
									>
										<FormLabel className="form-label-sm form-label-with-btns">
											<span>Value</span>
											{productNewForm.keyHighlights.length > 1 ? (
												<RiDeleteBin5Fill
													title="Delete Item"
													className="btn text-lg text-red-600"
													onClick={() =>
														removeKeyHighlight(index, setProductNewForm)
													}
												/>
											) : (
												""
										...
										<Input
											placeholder="Value"
											size="sm"
											value={productNewForm.keyHighlights[index].value}
											name="value"
											onChange={(e) => {
												handleKeyHighlightsChange(e, index, setProductNewForm);
											}}
						...
						<div className="add-more-btn">
							<CiCirclePlus
								className="text-3xl add-more-icon"
								onClick={() => {
									addNewKeyHighlight(setProductNewForm);
								}}
								title="Add More"
							/>
						</div>
				...
				<div className="product-category-sec">
					<div className="hidden-element">
						<Input
							...
							size="sm"
							onChange={(e) => {
								onMainImageChange(e, toast, setMainImageSrc, setProductNewForm);
							}}
							type="file"
					...
					<div className="grid grid-cols-1 md:grid-cols-4 gap-5 add-product-image-container">
						<FormControl
							className="col-span-3 add-product-image"
							size="lg"
							isRequired
						>
							<div className="add-image-main">
								<WrapItem className="add-more-image-btn">
									<Button
										colorScheme="red"
										onClick={() => {
											addImage(addImageInputRef);
										}}
										size="lg"
									>
										Add Image{" "}
										<CiCirclePlus className="text-3xl add-more-icon" />
									</Button>
								</WrapItem>
							</div>
							<div className="add-image-helper">
								<FormHelperText className="add-image-helper-text" size="xl">
									First image should be the main image.
								</FormHelperText>
							</div>
						</FormControl>
						<div
							className="add-product-image-preview add-product-image-preview-btns"
							style={{
				...
				<div className="product-category-sec">
					...
					<div className="grid grid-cols-1 md:grid-cols-4 gap-5">
						<FormControl
							size="sm"
							isRequired
							isInvalid={submitted && !productNewForm.basePrice}
						>
							<FormLabel className="form-label-sm">Base Price</FormLabel>
							<NumberInput
								size="sm"
								value={productNewForm.basePrice}
								onChange={(e) => {
									handleNumberInputChange(e, "basePrice", setProductNewForm);
								}}
							>
						...
						<FormControl
							size="sm"
							isRequired
							isInvalid={submitted && !productNewForm.moq}
						>
							<FormLabel className="form-label-sm">MOQ</FormLabel>
							<NumberInput
								size="sm"
								value={productNewForm.moq}
								onChange={(e) => {
									handleNumberInputChange(e, "moq", setProductNewForm);
								}}
							>
						...
						<FormControl
							as="fieldset"
							isRequired
							isInvalid={submitted && !productNewForm.isDiscounted}
						>
							<FormLabel className="form-label-sm" as="legend">
								Is Discounted?
							</FormLabel>
							<RadioGroup
								defaultValue="false"
						...
						</FormControl>
						{
							...
							productNewForm.isDiscounted === "true" ? (
								<FormControl
									isRequired
									isInvalid={submitted && !productNewForm.baseDiscount}
								>
									<FormLabel className="form-label-sm">
										Base Discount (%)
									</FormLabel>
									<NumberInput
										size="sm"
										value={productNewForm.baseDiscount}
										onChange={(e) => {
											handleNumberInputChange(
												e,
												"baseDiscount",
						...
						<FormControl
							as="fieldset"
							isRequired
							isInvalid={submitted && !productNewForm.taxType}
						>
							<FormLabel className="form-label-sm" as="legend">
								Tax Type
							</FormLabel>
							<RadioGroup
								size="sm"
								onChange={(e) => {
									handletaxTypeChange(e, setProductNewForm);
								}}
								value={productNewForm.taxType}
							>
								<HStack spacing="24px">
				...
				<p className="product-review-text text-md">
					Preview{" "}
					<FaEye
						className="product-preview-btn text-lg"
						onClick={() => {
			...
			{isPreviewOpen ? (
				<ProductPreviewModal
					...
					productDetails={{ ...productNewForm, mainImage: mainImageSrc }}
